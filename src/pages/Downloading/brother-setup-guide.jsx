              ...
              <div className="horizontal space-between">
                ...
                <div className="vertical side-images">
                  <div className="printer-container">
                    ...
                    />
                    <div className="printer-title">Brothers Printer</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="support-item">
                <div className="support-header horizontal">
                  ...
                  <div className="support-header-note">
                    ...
                    <a href="https://tawk.to/chat/66a8eee332dca6db2cb7758a/1i41uaahk">
                      Brother Support
                    </a>
                  </div>
                </div>
