              ...
              <div className="horizontal space-between">
                ...
                <div className="vertical side-images">
                  <div className="printer-container">
                    ...
                    />
                    <div className="printer-title">Epson PRINTERS</div>
                  </div>
                </div>
              </div>
            </div>
