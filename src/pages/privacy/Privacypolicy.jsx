...
const Privacypolicy = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mb-4">
        Still, please contact us if you have any questions or concerns about our
        privacy policy. We're committed to ensuring that your personal
        information is kept secure and used only for the purposes for which it
        was intended.
      </p>
    </div>
  );
